    ...
    var Plugin = {
        ...
        */
        ...
        handleSubmenuDropdownClick: function(e) {
            ...
            var item = this.closest('.kt-menu__itemx');
        ...
        handleSubmenuAccordion: function(e, el) {
            ...
            if ( Plugin.getSubmenuMode(el) === 'dropdown' && (query = item.closest('.kt-menu__itemx') ) ) {
            ...
            var li = item.closest('.kt-menu__itemx');
            var submenu = KTUtil.child(li, '.kt-menu__submenu, .kt-menu__inner');

            if (KTUtil.hasClass(item.closest('.kt-menu__itemx'), 'kt-menu__item--open-always')) {
                return;
            }
