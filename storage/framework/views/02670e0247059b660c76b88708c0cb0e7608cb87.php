<table class="table table-striped- table-bordered table-hover table-checkable" id="">
    ...
    <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
        ...
        <td data-field="Name" class="kt-datatable__cell"><?php echo $category->service->name; ?></td>
        <td data-field="IsStatus" class="kt-datatable__cell"><?php if($category->status): ?> On <?php else: ?> Off <?php endif; ?></td>
        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
            <a href="<?php echo route('items.import', [$category->id]); ?>" ><i class="la la-import">Import</i></a>
